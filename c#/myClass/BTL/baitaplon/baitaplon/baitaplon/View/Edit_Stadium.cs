...
{
    public partial class Edit_Stadium : Form
    {
        ...
        {
            InitializeComponent();
            txtMa.Text = Stadiums_SS.MaSan;
            txtTen.Text = Stadiums_SS.TenSan;
            txtSoGhe.Text = Stadiums_SS.SoGhe.ToString();
            txtDiaChi.Text = Stadiums_SS.ViTri;
        }
