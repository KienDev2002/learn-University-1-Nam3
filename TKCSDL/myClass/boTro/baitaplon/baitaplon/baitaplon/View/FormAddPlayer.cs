...
namespace baitaplon.View
{
    ...
    {
        string sqlString = "Data Source=DESKTOP-OSRNAUL\\SQLEXPRESS;Initial Catalog=QLGiaiBongNHA;Integrated Security=True";
        ...
        private new bool Validate()
        {
            ...
            {
                MessageBox.Show("Số áo không hợp lệ", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txtSoAo.Focus();
                return false;
            }
